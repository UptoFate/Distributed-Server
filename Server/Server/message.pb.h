...
class LoginReq final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_tocken(ArgT0&& arg0, ArgT... args);
  std::string* mutable_tocken();
  PROTOBUF_NODISCARD std::string* release_tocken();
  void set_allocated_tocken(std::string* tocken);
  private:
  const std::string& _internal_tocken() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_tocken(const std::string& value);
  std::string* _internal_mutable_tocken();
  public:
...
// string tocken = 2;
inline void LoginReq::clear_tocken() {
  _impl_.tocken_.ClearToEmpty();
}
inline const std::string& LoginReq::tocken() const {
  // @@protoc_insertion_point(field_get:message.LoginReq.tocken)
  return _internal_tocken();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginReq::set_tocken(ArgT0&& arg0, ArgT... args) {
 
 _impl_.tocken_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:message.LoginReq.tocken)
}
inline std::string* LoginReq::mutable_tocken() {
  std::string* _s = _internal_mutable_tocken();
  // @@protoc_insertion_point(field_mutable:message.LoginReq.tocken)
  return _s;
}
inline const std::string& LoginReq::_internal_tocken() const {
  return _impl_.tocken_.Get();
}
inline void LoginReq::_internal_set_tocken(const std::string& value) {
  
  _impl_.tocken_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginReq::_internal_mutable_tocken() {
  
  return _impl_.tocken_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginReq::release_tocken() {
  // @@protoc_insertion_point(field_release:message.LoginReq.tocken)
  return _impl_.tocken_.Release();
}
inline void LoginReq::set_allocated_tocken(std::string* tocken) {
  if (tocken != nullptr) {
    
  } else {
    
  }
  _impl_.tocken_.SetAllocated(tocken, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.tocken_.IsDefault()) {
    _impl_.tocken_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.LoginReq.tocken)
}
...
// string tocken = 3;
inline void LoginRsp::clear_tocken() {
  _impl_.tocken_.ClearToEmpty();
}
inline const std::string& LoginRsp::tocken() const {
  // @@protoc_insertion_point(field_get:message.LoginRsp.tocken)
  return _internal_tocken();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginRsp::set_tocken(ArgT0&& arg0, ArgT... args) {
 
 _impl_.tocken_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:message.LoginRsp.tocken)
}
inline std::string* LoginRsp::mutable_tocken() {
  std::string* _s = _internal_mutable_tocken();
  // @@protoc_insertion_point(field_mutable:message.LoginRsp.tocken)
  return _s;
}
inline const std::string& LoginRsp::_internal_tocken() const {
  return _impl_.tocken_.Get();
}
inline void LoginRsp::_internal_set_tocken(const std::string& value) {
  
  _impl_.tocken_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginRsp::_internal_mutable_tocken() {
  
  return _impl_.tocken_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginRsp::release_tocken() {
  // @@protoc_insertion_point(field_release:message.LoginRsp.tocken)
  return _impl_.tocken_.Release();
}
inline void LoginRsp::set_allocated_tocken(std::string* tocken) {
  if (tocken != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.LoginRsp.tocken)
}
