...
PROTOBUF_CONSTEXPR LoginReq::LoginReq(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.tocken_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.uid_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::message::LoginReq, _impl_.tocken_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::message::LoginRsp, _impl_.tocken_),
};
...
LoginReq::LoginReq(const LoginReq& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.tocken_){}
    , decltype(_impl_.uid_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.tocken_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.tocken_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_tocken().empty()) {
    _this->_impl_.tocken_.Set(from._internal_tocken(), 
      _this->GetArenaForAllocation());
  }
  _this->_impl_.uid_ = from._impl_.uid_;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_tocken();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "message.LoginReq.tocken"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* LoginReq::_InternalSerialize(
  ...
  // string tocken = 2;
  if (!this->_internal_tocken().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_tocken().data(), static_cast<int>(this->_internal_tocken().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.LoginReq.tocken");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_tocken(), target);
  }
...
void LoginReq::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_tocken().empty()) {
    _this->_internal_set_tocken(from._internal_tocken());
  }
  if (from._internal_uid() != 0) {
    _this->_internal_set_uid(from._internal_uid());
  }
...
void LoginReq::InternalSwap(LoginReq* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.tocken_, lhs_arena,
      &other->_impl_.tocken_, rhs_arena
  );
  swap(_impl_.uid_, other->_impl_.uid_);
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "message.LoginRsp.tocken"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* LoginRsp::_InternalSerialize(
  ...
  if (!this->_internal_tocken().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_tocken().data(), static_cast<int>(this->_internal_tocken().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.LoginRsp.tocken");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_tocken(), target);
  }
